...
void loop()
{
  if (doneY_0 == false) {
    ...
    if (ready == false) {
      ...
      int audioCode, audioCode7, fullscale;
      audioCode = analogRead(audioPin);
      fullscale = (int) 1023*1.1/0.96;
      audioCode = map(audioCode, 0, 1023, 0, fullscale);
      audioCode7 = audioCode/8;
