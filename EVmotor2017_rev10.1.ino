...
float targetDistance = 9.0, distanceRampDn = 1.0, distanceBreak = 0.0; // distanceBreak = how many m before finish line it starts to break
...
float targetVelocityStart = 1.0; // in m/s
